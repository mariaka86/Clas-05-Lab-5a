...
function sum(a, b) { 
  let theSum = a + b;
  let resultstring=[theSum, `The sum of ${a} and ${b} is ${theSum}.`];
  return resultstring;
}
...
Write a function called multiplyArray() that takes an array
 of numbers as its argument and returns an array whose first element
  is the product of those numbers, and the second element
   is a string that EXACTLY follows this example and uses
...
// Write your code here
//'The numbers 2,3,4 have a product of 24.'
//'The numbers 3,4 have a product of 12.'
function multiplyArray(multArr) { //eslint-disable-line
  let theProduct = 1;
  let numberAString='';
  let punctuation ='';
  for(let i = 0;i < multArr.length; i++) {
    theProduct *= multArr [i];
    numberAString += punctuation + multArr[i];
    punctuation= ',';
  } 
  return [theProduct,`The numbers ${numberAString} have a product of ${theProduct}.`];
}
